...
## Generated on : Sat Mar 08 22:22:19 2025
## Final product: ./APP_SensorFailureDetection.exe
...
MODELREF_LINK_RSPFILE     = APP_SensorFailureDetection_ref.rsp
...
PRODUCT = ./APP_SensorFailureDetection.exe
...
MODELREF_LIBS = hostobj/APP_SensorFailureDetection.obj

LIBS = $(START_DIR)/APP_SensorFailureDetection_ert_rtw/coderassumptions/pwslib/APP_SensorFailureDetection_ca.lib
...
xil_interface.obj : $(START_DIR)/APP_SensorFailureDetection_ert_rtw/sil/xil_interface.c
	$(CC) $(CFLAGS) -o "$@" "$<"


sil_main.obj : $(START_DIR)/APP_SensorFailureDetection_ert_rtw/sil/sil_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
