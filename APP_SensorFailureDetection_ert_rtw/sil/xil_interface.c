 ...
 *
 * SIL generated interface for code: "APP_SensorFailureDetection"
 *
 */

#include "APP_SensorFailureDetection.h"
...
XIL_INTERFACE_ERROR_CODE xilInitialize(uint32_T xilFcnId)
{
  ...
  /* Single In-the-Loop Component */
  if (xilFcnId == 0) {
    APP_SensorFailureDetection_initialize();
  } else {
   ...
   case XIL_OUTPUT_COMMAND:
    {
      ...
      if (!initComplete) {
        ...
        {
          void * dataAddress = (void *) &(rtU.APP_Sensor1);
        ...
        {
          void * dataAddress = (void *) &(rtU.APP_Sensor2);
          xil_fcnid0_task1_output_u[tableIdx].memUnitLength = 1 * sizeof(real_T);
          xil_fcnid0_task1_output_u[tableIdx++].address = (MemUnit_T *)
            dataAddress;
        }
...
XIL_INTERFACE_ERROR_CODE xilOutput(uint32_T xilFcnId, uint32_T xilTID)
{
  ...
  switch (xilTID) {
   case 1:
    APP_SensorFailureDetection_step();
    break;
   ...
   case XIL_INITIALIZE_COMMAND:
    {
      ...
      if (!initComplete) {
        ...
        {
          void * dataAddress = (void *) &(rtY.APP_SensorFailure1);
          xil_fcnid0_init_y[tableIdx].memUnitLength = 1 * sizeof(boolean_T);
          xil_fcnid0_init_y[tableIdx++].address = (MemUnit_T *) dataAddress;
        }

        {
          void * dataAddress = (void *) &(rtY.APP_SensorFailure2);
          xil_fcnid0_init_y[tableIdx].memUnitLength = 1 * sizeof(boolean_T);
          xil_fcnid0_init_y[tableIdx++].address = (MemUnit_T *) dataAddress;
        }

        {
          void * dataAddress = (void *) &(rtY.APP_SensorFailureCoherency);
          xil_fcnid0_init_y[tableIdx].memUnitLength = 1 * sizeof(boolean_T);
          xil_fcnid0_init_y[tableIdx++].address = (MemUnit_T *) dataAddress;
        }
