/*
 * APP_SensorFailureDetection_sbs.c
 *
 * Automatically generated s-function with I/O interface for:
 * Component: APP_SensorFailureDetection
 * Component Simulink Path: APP_SensorFailureDetection
 * Simulation Mode: SIL
 *
 */

#define S_FUNCTION_NAME                APP_SensorFailureDetection_sbs
...
static boolean_T startAndSetupApplication(SimStruct *S)
{
...

  {
    ...
    {
      mxArray * codeGenComponent = mxCreateString("SensorFailureDetection");
      mxArray *rhs[3];
      const char * simulinkBlockPath = ssGetPath(S);
      rhs[ 0 ] = mxCreateString(
        "@coder.connectivity.SimulinkInterface.getSILPILInterface");
